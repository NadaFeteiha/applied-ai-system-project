...
.ai-cta-label { color: #e8eaf6; font-weight: 600; font-size: 0.95em; }
.ai-cta-sub   { color: #6b7280; font-size: 0.8em; margin-top: 2px; }
...
# ── AI Assistant CTA ──────────────────────────────────────────────────────────
_cta_left, _cta_right = st.columns([5, 1])
with _cta_left:
    st.markdown(
        '<div class="ai-cta-banner">'
        '<div>'
        '<div class="ai-cta-label">🤖 PawPal AI Assistant</div>'
        '<div class="ai-cta-sub">Ask about pet care, vet availability, and appointment booking</div>'
        '</div>'
        '</div>',
        unsafe_allow_html=True,
    )
with _cta_right:
    ...
    if st.button("Open Chat →", use_container_width=True, type="primary"):
        st.switch_page("pages/Pet_Care_Assistant.py")
